...
\restrict Mw7n2NMcQDsM2RnjUOxvzIZVUWwVFdgbXk2MpZDBdykOdG5dqR3vUaRSaLtL5tK
...
CREATE DATABASE "new-exam" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'Chinese (Simplified)_China.936';


ALTER DATABASE "new-exam" OWNER TO postgres;

\unrestrict Mw7n2NMcQDsM2RnjUOxvzIZVUWwVFdgbXk2MpZDBdykOdG5dqR3vUaRSaLtL5tK
\encoding SQL_ASCII
\connect -reuse-previous=on "dbname='new-exam'"
\restrict Mw7n2NMcQDsM2RnjUOxvzIZVUWwVFdgbXk2MpZDBdykOdG5dqR3vUaRSaLtL5tK
